...
describe("directExecute", () => {
    ...
    it("can transfer through Cryptid", async () => {
        ...
        const signedTransaction = await cryptid.sign(makeTransaction(recipient.publicKey));
    ...
    it("can transfer through Cryptid with a second key on the DID", async () => {
        ...
        const execute = async () => {
            const signedTransaction = await secondKeyCryptid.sign(makeTransaction(recipient.publicKey));
