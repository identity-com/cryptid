...
import {BitwiseVerificationMethodFlag} from "@identity.com/sol-did-client/dist/src/lib/types";
...
export const addKeyToDID = async (authority: Wallet, key: PublicKey) => {
    ...
    const newKeyVerificationMethod = {
        flags: VerificationMethodFlags.of(BitwiseVerificationMethodFlag.CapabilityInvocation).array,
