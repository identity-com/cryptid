...
[[ $STAGE = "prod" ]] && ACCESS_IDENTITY="E2183FITBI7GYR" || ACCESS_IDENTITY="E2183FITBI7GYR"
[[ $STAGE = "prod" ]] && HOSTED_ZONE_ID="Z32EVO4M2RQREC" || HOSTED_ZONE_ID="Z32EVO4M2RQREC"
[[ $STAGE = "prod" ]] && CERTIFICATE_ARN="${PROD_ACCOUNT_CERTIFICATE_ARN}" || CERTIFICATE_ARN="${PROD_ACCOUNT_CERTIFICATE_ARN}"

[[ $STAGE = "prod" ]] && DOMAIN_PREFIX="cryptid" || DOMAIN_PREFIX="cryptid-${STAGE}"
PROJECT="cryptid"
