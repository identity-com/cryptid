...
import CryptidTypeSelector, {
  AddCryptidOrKeyTextType,
  AddCryptidOrKeyType,
} from './CryptidTypeSelector';
...
export default function AddKeyOrCryptidAccountModal({
  ...
  currentAccountAlias,
  modalType,
}: AddKeyOrCryptidAccountModalInterface) {
  ...
  const [addCryptidType, setAddCryptidType] =
    useState<AddCryptidOrKeyType>('adapterkey');
  ...
  const setValidatedImportKeyPair = useCallback(
    (value: string) => {
  ...
  const onCryptidTypeChange = useCallback(
  ...
  return (
    ...
    >
      <AddMnemonicModal
        ...
        onOK={() => setShowAddMnemonicDialog(false)}
            ...
            <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              ...
              <div className="sm:col-span-6">
                ...
                <div className="mt-1">
                  <CryptidTypeSelector
                    textType={modalType}
                    initialType={addCryptidType}
                    onChange={onCryptidTypeChange}
                  />
                </div>
              </div>
                ...
                <div className="sm:col-span-6">
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      name="importkey"
                      id="importkey"
                      autoComplete="importkey"
                      className="px-3 py-2 shadow-sm focus:ring-red-800 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 border rounded-md"
                      placeholder="Private Key"
                      onChange={(e) =>
                        setValidatedImportKeyPair(e.target.value.trim())
                      }
                    />
                  </div>
                </div>
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm w-full">
                      ...
                      <input
                        ...
                        // value={importAddress}
                        onChange={(e) =>
                          setValidatedAddress(e.target.value.trim())
                        }
                      />
                    </div>
                  </div>

                  {currentAccountAlias && modalType === 'cryptid' && (
                    <div className="sm:col-span-6">
                      <div className="m-1">
