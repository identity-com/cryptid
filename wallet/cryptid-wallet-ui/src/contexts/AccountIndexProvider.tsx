...
export const AccountIndexContext = createContext<AccountIndexState>(
...
export const AccountIndexProvider: FC<{ children: ReactNode }> = ({
  children,
}) => {
  const [accountIndex, setAccountIndex] = useLocalStorage("index", 0);

  return (
    <AccountIndexContext.Provider value={{ accountIndex, setAccountIndex }}>
      {children}
